...
function App() {
  ...
  useEffect(() => {
    if (showPopOver) setFirstLoad(false);
  }, [showPopOver]);
  ...
  return (
    <ErrorBoundary>
      <AppContainer>
        <div
          className={`tw-container tw-fixed tw-bottom-0 tw-right-0 tw-flex tw-flex-col tw-px-2 tw-z-40 tw-font-sans ${widthClasses}`}
        >
          <div
            className={`tw-flex tw-justify-end tw-items-center tw-mt-2 tw-mb-4 ${
              showPopOver ? "" : "tw-hidden"
            }`}
          >
            <ErrorBoundary>
          ...
          <div className="tw-flex tw-justify-end">
            ...
            >
              <span
                className={
                  "tw-absolute tw-inline-flex tw-h-full tw-w-full tw-rounded-full tw-bg-primary tw-opacity-20 md:t-opacity-50 tw-z-10 " +
