        ...
        {pageData && !recordingUri && (
          <>
            <Player
              ...
              onTranscriptReadyCB={(transcriptResponse) => {
                setRecordingUri();
                setRecordingObj(new Blob());
                setTranscription(transcriptResponse);
              }}
              recordOnTab={(onMessageListener) => {
                // Send a message to the extension to stop recording
                chrome.runtime.sendMessage({
                  command: "medispeak.startTabRecording",
                  data: pageData.id,
                });
                console.log("Adding Listener for medispeak.recordingLive");
